...
<html>
	<head>
		...
		<link rel="stylesheet" type="text/css"     href="http://<?php echo TemplateHelper::getSiteUrl(); ?>/css/production-omsk.css?37334" media="all" />
			...
			<div class="b-header-block">
				<div class="b-header-block_b-logotype">
					<a href="http://1chan.ru/">
						<img src="http://<?php echo TemplateHelper::getSiteUrl(); ?>/img/ogol.png" width="250" height="80" alt="1chan.ru" />
					</a>
				</div>
			...
			<div class="l-footer-wrap">
				...
				<div class="b-footer-copyrights">
					...
					<p>
						...
						<a href="http://hivemind.me/"><img src="http://<?php echo TemplateHelper::getSiteUrl(); ?>/img/dnimevih.gif" width="130" height="37" alt="" /></a>
					</p>
				</div>
			</div>
		</div>
