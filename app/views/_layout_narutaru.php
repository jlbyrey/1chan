...
<html>
	<head>
		...
		<link rel="stylesheet" type="text/css"     href="http://<?php echo TemplateHelper::getSiteUrl(); ?>/css/production-narutaru.css?37334" media="all" />
	...
	<img src="http://<?php echo TemplateHelper::getSiteUrl(); ?>/img/background-narutaru.jpg" width="100%" style="position: fixed; z-index: -1;" alt="" />
			...
			<div class="b-top-panel">
				<ul>
					...
					<li class="b-top-panel_m-right">
						<a href="http://1chan.ru/chat/475266264b1e9696e0370039311f83ee4cee8d413c47c/">Обратная связь</a>
					</li>
				</ul>
			</div>
			...
			<div class="b-header-block">
				<div class="b-header-block_b-logotype">
					<a href="http://1chan.ru/">
						<img src="http://<?php echo TemplateHelper::getSiteUrl(); ?>/img/logo-narutaru.png" width="250" height="80" alt="1chan.ru" />
					</a>
				</div>
