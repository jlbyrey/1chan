...
<html>
	<head>
		...
		<link rel="stylesheet" type="text/css"     href="http://<?php echo TemplateHelper::getSiteUrl(); ?>/css/production-omsk.css?23" media="all" />
		...
		<script type="text/javascript" src="http://<?php echo TemplateHelper::getSiteUrl(); ?>/js/production.js?55"></script>
	</head>
