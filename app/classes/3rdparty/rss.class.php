...
class rss {
    ...
    function itemDescription($description){ $this->itemDescription = htmlspecialchars($description); }
    ...
    function addItem(){
        ...
        if(!empty($this->itemTitle)){ $this->rss .= $this->s(3) . '<title>' . preg_replace("/(\xC2\xAD)/", "", $this->itemTitle) . '</title>' . "\n"; }
